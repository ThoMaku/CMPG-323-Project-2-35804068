...
using CMPG323_Project2.Authentication;
...
builder.Services.AddDbContext<CMPG323Project2Context>(options => options.UseSqlServer(
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Name = "Authorization",
        Description = "JWT Authorization header using the Bearer scheme. \r\n\r\n Enter 'Bearer' [space] and then your Bear token in the text input below.\r\n\r\nExample: \"Bearer 1safsfsdfdfd\"",
